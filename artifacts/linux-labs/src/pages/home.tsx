  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <motion.header
        ...
        className="sticky top-0 z-20 border-b border-primary/20 bg-[hsl(var(--nav-bg))] backdrop-blur-sm"
      >
      ...
      {/* ── Footer ── */}
      <footer className="relative z-10 border-t border-primary/20 py-4 bg-[hsl(var(--nav-bg))] backdrop-blur-sm">
