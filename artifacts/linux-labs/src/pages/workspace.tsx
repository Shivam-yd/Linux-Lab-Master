        ...
        <div className="w-[450px] shrink-0 border-r border-border/50 bg-card/40 flex flex-col relative z-10 shadow-[4px_0_24px_rgba(0,0,0,0.2)]">
          <div className="flex-1 overflow-y-auto p-6 scrollbar-thin scroll-smooth">
            ...
            <div className="mb-6 pb-4 border-b border-border/40">
              <div className="prose prose-sm max-w-none prose-p:text-foreground/80 prose-headings:text-foreground prose-strong:text-foreground prose-li:text-foreground/80 prose-a:text-primary prose-code:text-primary prose-code:bg-primary/10 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-ul:my-2 prose-li:my-0.5">
                ...
                {stepsRevealed === 0 ? (
                  ...
                  <div className="px-4 pb-4 space-y-3">
                    {stepsList.slice(0, stepsRevealed).map((step, i) => (
                      <div
                        key={i}
                        className="execution-step-markdown p-3.5 rounded-lg bg-muted/30 border border-border/40 prose prose-sm max-w-none prose-p:my-0 prose-code:text-primary prose-code:bg-primary/10 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:font-mono prose-pre:bg-muted/60 prose-pre:border prose-pre:border-border/40 animate-in fade-in slide-in-from-top-2 duration-300"
                      >
