...
export default function CertificatePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground print:bg-white">
      <header className="print:hidden sticky top-0 z-20 border-b border-primary/20 bg-[hsl(var(--nav-bg))] backdrop-blur-sm flex items-center justify-between px-6 py-4">
