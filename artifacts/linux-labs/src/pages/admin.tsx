...
export default function AdminPage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-background text-foreground overflow-hidden">
      ...
      {/* Header */}
      <header className={cn("sticky top-0 z-20 border-b transition-all duration-200", scrolled ? "border-primary/20 bg-primary/[0.07] dark:bg-primary/[0.07] backdrop-blur-md" : "border-transparent")}>
