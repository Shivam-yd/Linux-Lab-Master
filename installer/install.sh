...
if [[ -f "${ENV_FILE}" ]]; then
  ...
  # ── Clerk authentication (keys embedded at build time) ───────────────────────
  CLERK_SECRET_KEY="sk_test_WR4U77oj9bWMpOBoLYgsST0Oed7M0nEO1fi4dbKOBO"
  CLERK_PUBLISHABLE_KEY="pk_test_b24tcm9iaW4tNDIuY2xlcmsuYWNjb3VudHMuZGV2JA"
